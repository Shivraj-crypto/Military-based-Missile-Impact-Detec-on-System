...
This project implements a real-time impact / explosion detection system using a self-trained YOLOv3 deep learning model. It combines computer vision, GPS localization, geospatial calculations, and automated alerting to detect explosions from a live video feed and estimate their real-world coordinates.

The system is designed to work with:

A physical camera or OBS virtual camera
